...
import { module4Lessons, type Module4Lesson } from './data/lessons';
...
export default function Module4() {
  ...
  const lesson: Module4Lesson = module4Lessons[currentLessonIndex] || module4Lessons[0];
  ...
  if (!lesson || !game) {
    return <div className="p-8 text-center text-slate-500">Cargando lección del Módulo 4...</div>;
  }
    ...
    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 md:p-8 flex flex-col md:flex-row gap-8 min-h-[600px] transition-colors duration-300">
      ...
      <div className="flex-1 flex flex-col gap-6">
        <div>
          <div className="flex items-center justify-between mb-4">
            <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wider">
              Módulo 4 - Lección {currentLessonIndex + 1} de {module4Lessons.length}
            </span>
        ...
        <div className="mt-auto pt-6 border-t border-slate-100 flex justify-between items-center">
          ...
          {currentLessonIndex < module4Lessons.length - 1 ? (
            <button 
              onClick={() => nextLesson(module4Lessons.length)}
