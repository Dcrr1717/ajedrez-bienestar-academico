      ...
      <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-sm sticky top-0 z-50 transition-colors duration-300">
        <div className="w-full px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link to="/module/6.1" className={`flex items-center gap-2 px-3 py-1.5 rounded-lg font-medium text-sm transition-colors ${currentModule === 6.1 ? 'text-blue-600 bg-blue-50 dark:bg-blue-950/30' : 'text-slate-500 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/30'}`}>
              <BookOpen size={16} />
              <span>6.1</span>
            </Link>
            <Link to="/module/7" className={`flex items-center gap-2 px-3 py-1.5 rounded-lg font-medium text-sm transition-colors ${currentModule === 7 ? 'text-blue-600 bg-blue-50 dark:bg-blue-950/30' : 'text-slate-500 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/30'}`}>
              <BookOpen size={16} />
              <span>Módulo 7</span>
            </Link>
            <Link to="/module/8" className={`flex items-center gap-2 px-3 py-1.5 rounded-lg font-medium text-sm transition-colors ${currentModule === 8 ? 'text-blue-600 bg-blue-50 dark:bg-blue-950/30' : 'text-slate-500 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/30'}`}>
              <BookOpen size={16} />
              <span>Módulo 8</span>
            </Link>
          </nav>
